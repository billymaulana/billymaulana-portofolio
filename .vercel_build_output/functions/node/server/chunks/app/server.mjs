...
import { u as useRuntimeConfig$1 } from '../nitro/vercel.mjs';
...
const components = {};
function componentsPlugin_c120b104(nuxtApp) {
...
const vueuseHead_2b447d1a = defineNuxtPlugin((nuxtApp) => {
...
const metaConfig = { "globalMeta": { "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "meta": [], "link": [{ "rel": "icon", "type": "image/png", "href": "/nuxt.png" }], "style": [], "script": [], "title": "Vitesse Nuxt 3" }, "mixinKey": "created" };
const metaMixin = {
  [metaConfig.mixinKey]() {
    var _a2;
    const instance = vue_cjs_prod.getCurrentInstance();
...
const plugin_5c88ade4 = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$d = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Counter = _sfc_main$e;
...
function watchPausable(source, cb, options = {}) {
  ...
  const stop = watchWithFilter(source, cb, __spreadProps$1(__spreadValues$1$1({}, watchOptions), {
    eventFilter
  }));
...
const _sfc_main$a = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    useRouter();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)}><input id="input"${serverRenderer.exports.ssrRenderAttr("value", name.value)} placeholder="What&#39;s your name?" type="text" autocomplete="false" p="x-4 y-2" m="t-5" w="250px" text="center" bg="transparent" border="~ rounded gray-200 dark:gray-700" outline="none active:none"><div><button class="m-3 text-sm btn"${serverRenderer.exports.ssrIncludeBooleanAttr(!name.value) ? " disabled" : ""}> GO </button></div></div>`);
    };
  }
});
...
const routes = [
  {
    name: "hi-id",
    path: "/hi/:id",
    file: "/Users/billymaulana/Documents/billy/works/billymaulana-portofolio/pages/hi/[id].vue",
    children: [],
    meta: meta$1,
    alias: [],
  ...
  },
  {
    name: "index",
    path: "/",
    file: "/Users/billymaulana/Documents/billy/works/billymaulana-portofolio/pages/index.vue",
    children: [],
    meta,
    alias: [],
    component: () => Promise.resolve().then(function() {
...
const router_2c22b9f6 = defineNuxtPlugin((nuxtApp) => {
...
const ssrPlugin_6aa64f34 = () => {
};
const _plugins = [
  preload,
  componentsPlugin_c120b104,
  vueuseHead_2b447d1a,
  plugin_5c88ade4,
  router_2c22b9f6,
  PiniaNuxtPlugin,
...
const Error404 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-b11ad3a6"]]);
const _sfc_main$8 = {
  __ssrInlineRender: true,
  props: {
    appName: {
...
const Error500 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-18181656"]]);
const _sfc_main$6 = {
  __ssrInlineRender: true,
  props: {
    error: Object
      ...
      serverRenderer.exports.ssrRenderSuspense(_push, {
        default: () => {
          if (vue_cjs_prod.unref(error)) {
            _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(_sfc_main$6), { error: vue_cjs_prod.unref(error) }, null, _parent));
          } else {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<a i-carbon-logo-github href="https://github.com/antfu/vitesse-nuxt3" target="__blank"></a>`);
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext = {}) {
    const vueApp = vue_cjs_prod.createApp(_sfc_main$5);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Logos = __nuxt_component_0$1;
  const _component_PageView = _sfc_main$b;
  const _component_InputEntry = _sfc_main$a;
