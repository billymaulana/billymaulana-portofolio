...
const _93880f = () => import('../pageview.mjs');
const _8534f7 = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/pageview', handler: _93880f, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _8534f7, lazy: true, method: undefined },
  { route: '/**', handler: _8534f7, lazy: true, method: undefined }
];
...
export { useRuntimeConfig as u, vercel as v };
