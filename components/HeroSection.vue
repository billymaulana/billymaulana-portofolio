...
<template>
  ...
  >
    <div class="absolute inset-0 pointer-events-none">
      <div class="absolute top-20 left-10 w-32 h-32 border-3 border-primary/20 animate-float" />
      <div class="absolute bottom-40 right-20 w-24 h-24 bg-secondary/10 animate-pulse-glow" />
      <div class="absolute top-1/3 right-1/4 w-16 h-16 border-3 border-accent/20 rotate-45" />
      <div class="absolute bottom-1/4 left-1/3 w-20 h-20 bg-electric/10 rounded-full" />
    </div>

    <div class="container-custom section-padding relative z-10">
      <div class="max-w-5xl">
        <div ref="subtitleRef" class="mb-4">
        ...
        <h1
          ref="titleRef"
          class="text-fluid-hero font-accent leading-none mb-6"
        >
          <span class="block">BILLY</span>
          <span class="block text-primary">MAULANA</span>
        </h1>

        <div ref="descRef" class="max-w-2xl mb-8">
    ...
    <div
      ...
      class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 cursor-pointer"
      @click="scrollToAbout"
    >
