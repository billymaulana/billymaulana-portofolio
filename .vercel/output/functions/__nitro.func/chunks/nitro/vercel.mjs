...
const inlineAppConfig = {
  "nuxt": {
    "buildId": "ba322db3-1d29-4e52-b621-c9674e5a62e3"
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/billymaulana/Data Billy/Works/billy-portofolio/billymaulana-portofolio/.data/kv"}));
...
const _yU6Qgs87D0 = (function(nitro) {
...
const _lazy_LmopZ6 = () => import('../pageview.mjs');
const _lazy_JaNQPz = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/pageview', handler: _lazy_LmopZ6, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_JaNQPz, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_JaNQPz, lazy: true, middleware: false, method: undefined }
];
